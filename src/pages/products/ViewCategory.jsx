...
export default function ViewCategory({onBack}) {
  ...
  const handleSaveEdit = (index) => {
    ...
    const newData = [...data];
    newData[(currentPage - 1) * categoriesPerPage + index].category = editValue;
    setData(newData);
  ...
  const handleDelete = (index) => {
    const globalIndex = (currentPage - 1) * categoriesPerPage + index;
